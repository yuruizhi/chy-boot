...
public class LoggingAspectAnnotationDriven {
    ...
    @Before("@annotation(com.changyi.chy.commons.component.log.LogStyle)")
    ...
    @AfterReturning(value = "@annotation(com.changyi.chy.commons.component.log.LogStyle)", returning = "result")
