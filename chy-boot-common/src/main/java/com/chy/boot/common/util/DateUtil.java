package com.chy.boot.common.util;
...
public class DateUtil {
	 ...
	 * 将字符串转换为时间戳
	 * 如：
	 * parseToTimeMills("2020-04-01T15:24:21.051+0800", "yyyy-MM-dd'T'HH:mm:ss.SSSZ")
	 * parseToTimeMills("2020-04-01T09:34:47.744Z", "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'")
	 *
	 * @param dateStr 时间字符串
	 * @param format  表达式
	 * @return 时间戳
