...
import com.chy.boot.common.util.BeanUtil;
...
public class LoggingAspectAnnotationDriven {
    ...
    @Before("@annotation(com.chy.boot.common.component.log.LogStyle)")
    ...
    @AfterReturning(value = "@annotation(com.chy.boot.common.component.log.LogStyle)", returning = "result")
