...
import com.chy.boot.common.commons.util.BeanUtil;
...
public class LoggingAspectAnnotationDriven {
    ...
    @Before("@annotation(com.chy.boot.common.commons.component.log.LogStyle)")
    ...
    @AfterReturning(value = "@annotation(com.chy.boot.common.commons.component.log.LogStyle)", returning = "result")
