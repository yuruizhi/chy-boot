 ...
 */
package com.chy.boot.commons.jackson;

import com.chy.boot.commons.util.DateUtil;
import com.chy.boot.commons.util.Exceptions;
import com.chy.boot.commons.util.StringPool;
...
public class JsonUtil {
     ...
     * @return
     */
    public static <T> String object2EscapeJson(T value) {
     ...
     * @return
     */
    public static <T> String jsonStr2EscapeStr(String value) {
        String str = value;
        try {
            str = str.replaceAll("\"", "\\\\\"");
        } catch (Exception e) {
    ...
    public static class JacksonObjectMapper extends ObjectMapper {
        ...
        public JacksonObjectMapper() {
            ...
            //日期格式化
            super.registerModule(new CyJavaTimeModule());
            super.findAndRegisterModules();
        }
